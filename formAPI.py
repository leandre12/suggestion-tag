...
option = st.sidebar.selectbox('choisissez votre modèle de prédiction :',
                              ('LogisticRegression', 'SGDClassifier',
                               ...
                               'PassiveAggressiveClassifier', 'RandomForest', 'KNN'))
...
top1000words_exp = pd.read_csv('data/Backup/top1000_words.csv',header=None, index_col=0,squeeze=True).to_dict()
top100tags_exp = pd.read_csv('data/Backup/top100_tags.csv',header=None, index_col=0,squeeze=True).to_dict()
